...
int main(int ac, char* av[])
{
  ...
  double** input_p = create_matrix<double>(width_c, width_c);
  double** output_p_t = create_matrix<double>(width_c, width_c);
  double** output_p = create_matrix<double>(width_c, width_c);
